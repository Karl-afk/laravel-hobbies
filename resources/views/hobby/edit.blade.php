                ...
                <div class="card-body">
                    ...
                    <form action="/hobby/{{ $hobby->id }}" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <textarea type="text" class="form-control {{ $errors->has('beschreibung') ? 'border-danger' : '' }}" id="beschreibung" rows="5" name="beschreibung" value="{{ old('beschreibung') ?? $hobby->beschreibung }}"></textarea>
